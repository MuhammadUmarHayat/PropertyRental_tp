...
<section >
    ...
    <div>
    <a class="nav-link" href="newFlat.php">New Flat</a>
    </div>
...
<?php echo $row['owner'] ?><br>
       ...
       Status: <?php echo $row['status'] ?><br>
        ...
        <?php echo '<a  text-decoration: none;"  href="edit_flat.php?id=' . $row['id'] . '">Edit Details</a>';?>
         <?php echo '<a text-decoration: none;"  href="delete_flat.php?id=' . $row['id'] . '">Remove Details</a>';?>
         </td>   
