...
//email,name,cnic,password,retypePassword,address,phoneNo
	...
	$usertype="manager";
		...
		$query="INSERT INTO `users`( `name`, `cnic`, `address`, `password`, `email`, `phone`, `town`, `city`, `region`, `zipcode`, `country`,`usertype`) VALUES ('$name','$cnic','$address','$password','$email','$phoneNo','$town','$city','$region','$zip','$country','$usertype')";
...
<main>
            ...
            <form method="post" action="managerSignup.php">
    <div class="center">
        
<table>
<tr> <td><h2> Manager Registration </h2> </td> <td></td>   </tr>
...
<tr><td></td><td> <button type="submit" class="btn btn-success" name="signup"> Register Now </button>  </td>   </tr>
</table>
<?php
echo $message;
?>
